...
def test_get_form(
    ...
    resp = app.get("/dossiers/1/lectures/an.15.806.PO744107/options", user=user_david)
    ...
    assert (
        form.action
        == "https://zam.test/dossiers/1/lectures/an.15.806.PO744107/import_liasse_xml"
    )
...
def test_upload_liasse_success(
    ...
    assert (
        resp.location
        == "https://zam.test/dossiers/1/lectures/an.15.806.PO744107/amendements"
    )
...
def test_upload_liasse_missing_file(
    ...
    assert (
        resp.location
        == "https://zam.test/dossiers/1/lectures/an.15.806.PO744107/options"
    )

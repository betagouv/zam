...
class Senat(RemoteSource):
    ...
    def _enrich_one(
        ...
        mission = discussion_details.mission
        if mission:
            amendement_mission, _ = get_one_or_create(
                AmendementMission,
                amendement=amendement,
                titre=mission.titre,
                titre_court=mission.titre_court,
            )
        else:
            amendement_mission = None

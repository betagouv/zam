class UnsavedChanges extends Stimulus.Controller {
    ...
    leaving(event) {
        if (this.isFormChanged()) {
            ...
            event.returnValue = "Si vous quittez cette page sans cliquer sur le bouton Enregistrer, vos modifications seront perdues. Êtes-vous sûr(e) de vouloir quitter cette page?";
